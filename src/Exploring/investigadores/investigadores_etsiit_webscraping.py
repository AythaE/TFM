...
def get_investigadores():
    ...
    for tr in table.find_all('tr'):
        ...
        row = {table_header[i]: row_cells[i]
...
def get_grupos():
    # specify the url
    search_page = base_url + \
        '/ugrinvestiga/pages/doc_catologo/tic_ponencia'
    ...
    grupos_df = pd.DataFrame(data)


    grupos_df.to_excel('grupos_investigacion_codigos.xlsx', index=False)
